...
test.suite({
  ...
  for tc in [
    ...
    },
    {
      ...
      expect: |||
        Validation failure: Validated field `foo` is unset
    ...
    },
    {
      ...
      expect: |||
        Validation failure: Required field `foo` is null
        In validate_test.TestClass
      |||,
    },
    {
      ...
      expect: |||
        Validation failure: Field `foo` has type `string`, expected `number`
        In validate_test.TestClass
      |||,
    },
    {
      ...
      expect: |||
        Validation failure: Field `foo` has type `boolean`, expected one of (`number`, `string`)
        In validate_test.TestClass
      |||,
    },
    {
      ...
      instance: validate.Validate + {
        ...
        __validate__+:: [{
          name: 'validate_test.TestClass',
          validators+: [
            validate.field('foo').arrayOf('number'),
          ],
        }]
      },
      expect: |||
        Validation failure: Field `foo` element `0` has type `string`, expected `number`
        In validate_test.TestClass
      |||,
    },
    {
      ...
      instance: validate.Validate + {
        ...
        __validate__+:: [{
          name: 'validate_test.TestClass',
          validators+: [
            validate.field('foo').arrayOf('string'),
          ],
        }]
      },
      expect: |||
        Validation failure: Field `foo` element `1` has type `null`, expected `string`
        In validate_test.TestClass
      |||,
    },
    {
      ...
      expect: |||
        Validation failure: Field `foo` element `1` has type `null`, expected one of (`number`, `string`)
        In validate_test.TestClass
      |||,
    },
    {
      ...
      expect: |||
        Validation failure: Field `foo` has value `3`, not greater than bound `3`
        In validate_test.TestClass
      |||,
    },
    {
      ...
      expect: |||
        Validation failure: Field `foo` has value `3`, not greater than or equal to bound `4`
        In validate_test.TestClass
      |||,
    },
    {
      ...
      expect: |||
        Validation failure: Field `foo` has value `3`, not less than bound `3`
        In validate_test.TestClass
      |||,
    },
    {
      ...
      expect: |||
        Validation failure: Field `foo` has value `3`, not less than or equal to bound `2`
        In validate_test.TestClass
      |||,
    },
    {
      ...
      expect: |||
        Validation failure: Field `foo` has disallowed value `3`
        In validate_test.TestClass
      |||,
    },
    {
      ...
      expect: |||
        Validation failure: Field `foo` has value `3`, expected one of (`2`, `4`)
        In validate_test.TestClass
      |||,
    },
    {
      ...
      expect: |||
        Validation failure: Field `foo` is empty array
        In validate_test.TestClass
      |||,
    },
    {
      ...
      expect: |||
        Validation failure: Field `foo` failed check function with message: <message>
        In validate_test.TestClass
      |||,
    },
    {
      ...
      expect: |||
        Validation failure: Required field `garply` is null
